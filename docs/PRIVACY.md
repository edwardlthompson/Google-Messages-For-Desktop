...
- Stored locally in device-only `product-update.json`: last check time, last seen version, dismissed installer version
- Donate prefs stay on this device and are not peer-synced
- No PII transmitted
