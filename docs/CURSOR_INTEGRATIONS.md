...
|-------|----------|--------|
| Rules | `.cursor/rules/*.mdc` | Shipped (14 FOSS; commercial-compliance stays hidden) |
...
| Codex review (opt-in) | `docs/CODEX_REVIEW.md` + `/codex-review` + workflow example | Example |
