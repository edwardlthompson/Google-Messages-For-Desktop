...
Source the GitHub Release `.deb`. Do not vendor Electron in git.
...
source=("https://github.com/edwardlthompson/Google-Messages-For-Desktop/releases/download/v${pkgver}/Google.Messages-v${pkgver}-linux-amd64.deb")
